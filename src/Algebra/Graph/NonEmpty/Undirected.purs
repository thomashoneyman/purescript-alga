-- |
-- | Missing: tree, forest
module Algebra.Graph.NonEmpty.Undirected where
...
-- import Algebra.Graph.NonEmpty as G
...
-- -- TODO: we need undirected versions of Internal.Focus and co
...
-- --   f | f.ok -> Just { edges: f.is, outputs: f.os }
-- --   _ -> Nothing
