...
-- |   - tree
-- |   - forest
module Algebra.Graph.AdjacencyMap.Undirected 
  ( -- Data structure
    module Algebra.Graph.AdjacencyMap.Undirected.Internal,
...
import Algebra.Graph.AdjacencyMap.Undirected.Internal (AdjacencyMap(..))
...
-- TODO: Should there even be a symmetric closure for Undirected Adjacency Maps?
